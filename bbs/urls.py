...
urlpatterns = [
    ...
    path('notice/add/', bbs_views.PostCreateView.as_view(), name='notice-add'),
    path('notice/<int:pk>/', bbs_views.PostDetailView.as_view(), name='notice-detail'),
    path('notice/<int:pk>/delete', bbs_views.PostDeleteView.as_view(), name='notice-delete'),
    path('notice/<int:pk>/update', bbs_views.PostUpdateView.as_view(), name='notice-update'),
]
